...
const SMALL = {
  ...
  furniture: [
    ...
    { type: "desk", id: "studio-a", label: "Bancada A", x: 14, y: 28, w: 16, h: 6.5, monitors: 4, solid: true },
    { type: "desk", id: "studio-b", label: "Bancada B", x: 14, y: 40, w: 16, h: 6.5, monitors: 4, solid: true },
    { type: "table", cx: 76, cy: 33, rx: 4, solid: true },
    { type: "desk", id: "focus-a", label: "Mesa Foco 1", x: 78, y: 56, w: 6, h: 6, monitors: 1, solid: true },
    { type: "desk", id: "focus-b", label: "Mesa Foco 2", x: 78, y: 68, w: 6, h: 6, monitors: 1, solid: true },
...
const MEDIUM = {
  ...
  furniture: [
    ...
    { type: "desk", id: "team-a", label: "Bancada A", x: 22, y: 32, w: 13.7, h: 6.9, monitors: 3, solid: true },
    { type: "desk", id: "team-b", label: "Bancada B", x: 22, y: 48, w: 13.7, h: 6.9, monitors: 3, solid: true },
    { type: "table", cx: 70, cy: 41, rx: 5.1, solid: true },
    { type: "desk", id: "focus-1", label: "Mesa Foco 1", x: 60, y: 74, w: 6.6, h: 6.3, monitors: 1, solid: true },
    { type: "desk", id: "focus-2", label: "Mesa Foco 2", x: 76, y: 74, w: 6.6, h: 6.3, monitors: 1, solid: true },
...
const LARGE = {
  ...
  furniture: [
    ...
    // Dev
    { type: "desk", id: "dev-a", label: "Dev A", x: 15, y: 26, w: 16, h: 6, monitors: 4, solid: true },
    { type: "desk", id: "dev-b", label: "Dev B", x: 15, y: 38, w: 16, h: 6, monitors: 4, solid: true },
    { type: "plant", x: 14, y: 47 },
    // Design
    { type: "whiteboard", x: 20, y: 57.4, w: 10, h: 3.4 },
    { type: "desk", id: "design-a", label: "Design A", x: 16, y: 62, w: 8, h: 5.5, monitors: 2, solid: true },
    { type: "desk", id: "design-b", label: "Design B", x: 28, y: 62, w: 8, h: 5.5, monitors: 2, solid: true },
